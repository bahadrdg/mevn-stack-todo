    ...
    },
    {
        ...
        command: async () => {
            try {
                ...
                authStore.logout(); // Store'daki token'ı temizle
                router.push('/login');
            } catch (error) {
            ...
            <div class="layout-topbar-menu hidden lg:block">
                <div class="layout-topbar-menu-content">
                    ...
                    <div class="relative">
                        ...
                        <Menu ref="menu" :model="items" class="surface-overlay border-round-md shadow-2 absolute origin-top" style="top: 100%; right: 0; min-width: 200px" />
                    </div>
                </div>
            </div>
        </div>
